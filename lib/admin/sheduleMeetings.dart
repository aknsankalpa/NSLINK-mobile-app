...
import 'package:nslink_new/admin/homeScreen.dart'; // Fixed package name
...
class _ScheduleMeetingsState extends State<ScheduleMeetings> {
  ...
  final Map<String, List<String>> departmentsByFaculty = {
    ...
    'Engineering': [
      ...
      'Design Studies',
      'Mechatronic and Industrial Engineering',
    ],
    'Science': ['Life Sciences', 'Health Sciences'],
  };
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items:
                          currentDepartments.map<DropdownMenuItem<String>>((
                            String value,
                          ) {
                            return DropdownMenuItem<String>(
                              value: value,
