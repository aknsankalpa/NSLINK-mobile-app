...
import 'package:nslink_new/library/frontend/screens/admin/admin_login_screen.dart';
  ...
  Future<void> _sendData() async {
    ...
    try {
      ...
      if (userDoc.exists) {
        ...
        await prefs.setString('user_role', role); // Store the user's role
                      ...
                      child: Column(
                        children: [
                          ...
                          TextField(
                            ...
                            obscureText:
                                !_isPasswordVisible, // Modified this line
                            decoration: InputDecoration(
                              filled: true,
                              fillColor: Colors.grey[200],
                              hintText: 'Password',
